...
int main()
{
    int agencia,dig4,dig3,dig2,dig1,modulo11,auxiliar;
    printf("informe o numero da sua agencia\n");
    scanf("%i",&agencia);
    auxiliar=agencia;//foi copiado conteudo d agencia para ser usado no fim d codigo
    dig4=agencia%10;
    agencia=agencia/10;
    dig3=agencia%10;
    agencia=agencia/10;
    dig2=agencia%10;
    dig1=agencia/10;
    modulo11=2*(dig4)+3*(dig3)+4*(dig2)+5*(dig1);
    modulo11=11-(modulo11%11);
   if(modulo11==10)
   {
       printf("%i-x\n",auxiliar);
   }
